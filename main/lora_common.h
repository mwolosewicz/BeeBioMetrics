...
#define LORA_MSG_MACADDR_SZ 8			// MAC address size
#define LORA_MSG_IDX_SZ 2			// Message index size
#define LORA_MSG_TYPE_SZ 1			// Type size
#define LORA_MSG_DOUBLE_SZ SERIALIZED_DOUBLE_SZ	// Size of double - 64bits


#define LORA_MSG_MACADDR_OFFSET 0
#define LORA_MSG_IDX_OFFSET (LORA_MSG_MACADDR_OFFSET + LORA_MSG_MACADDR_SZ)
#define LORA_MSG_TYPE_OFFSET (LORA_MSG_IDX_OFFSET + LORA_MSG_IDX_SZ)
#define LORA_MSG_TEMPERATURE_OFFSET (LORA_MSG_TYPE_OFFSET + LORA_MSG_TYPE_SZ)
#define LORA_MSG_HUMIDITY_OFFSET (LORA_MSG_TEMPERATURE_OFFSET + LORA_MSG_DOUBLE_SZ)
#define LORA_MSG_PRESSURE_OFFSET (LORA_MSG_HUMIDITY_OFFSET + LORA_MSG_DOUBLE_SZ)
